<%@ Page Title="" Language="C#" MasterPageFile="~/SitioM.Master" AutoEventWireup="true" CodeBehind="AgregarPersonas.aspx.cs" Inherits="AuLearn_Web.AgregarPersonas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="BreadCrumb" runat="server">
    <i class="fa fa-users"></i> Administración Personas
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <div class="row">
        <div class="col-lg-5" runat="server">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-users"></i><asp:label runat="server" id="labelTitulo"> Administración Personas</asp:label>
                </div>
                <div class="card-body">
                    <div class="row">
                     <div class="col-lg-6">
                    ...
                    <asp:DropDownList AutoPostBack="true" OnSelectedIndexChanged="DropDownListCargo_SelectedIndexChanged" ID="DropDownListCargo" runat="server" class="form-control" DataSourceID="SqlDataSource1" DataTextField="cargo" DataValueField="id_cargo"></asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:aulearnConnectionString %>" SelectCommand="SELECT [id_cargo], [cargo] FROM [Cargo] where id_cargo != 1004 and id_cargo != 1005"></asp:SqlDataSource>
                    <br />
            ...
            Display="Dynamic" ErrorMessage="RUT incorrecto" SetFocusOnError="True" ForeColor="Red"></asp:CustomValidator>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <label>Nombres</label>
                            <asp:TextBox ID="txtNombre" runat="server" class="form-control col-xs-3" placeholder="Nombres" onKeyPress="edValueKeyPress()" onKeyUp="edValueKeyPress()"></asp:TextBox>
                        ...
                        <div class="col-lg-6">
                            ...
                            <asp:TextBox ID="txtApellido" runat="server" class="form-control" placeholder="Apellidos" onKeyPress="edValueKeyPress()" onKeyUp="edValueKeyPress()"></asp:TextBox>
                   ...
                   <%-- <asp:TextBox ID="txtPrev" runat="server" class="form-control col-xs-3" placeholder="Ecriba un nombre y apellido en los campos anteriores"></asp:TextBox>--%>
                    ...
                    <div id="divOtrosCargos" runat="server">
                        ...
                        <asp:TextBox ID="TextFono" runat="server" class="form-control" placeholder="Ejemplo: 912345678" MaxLength="9"></asp:TextBox>
        ...
        <div class="col-lg-6">
            ...
            <br />
            <asp:GridView ID="GridPersonas" runat="server"
                ...
                <Columns>
                    ...
                    <asp:ButtonField ButtonType="Button" CommandName="Editar" HeaderText="Editar Persona" Text="Editar" ControlStyle-CssClass="btn btn-primary btn-block"  />
                    <%--<asp:TemplateField>
                        <ItemTemplate>
...
P.activo as 'Estado'
 from Persona P
inner join Cargo C on C.id_cargo=P.id_cargo where C.id_cargo != 1004 and C.id_cargo != 1005"></asp:SqlDataSource>
    ...
    <script>
        function edValueKeyPress() {
            ...
            var nombreusuarioC = primernombre + "." + primerApellido;
            var nombreusuarioSinMayusculas = nombreusuarioC.toLowerCase()
            var nombreusuarioSinTildes = getCleanedString(nombreusuarioSinMayusculas);
            ...
            lblValue.innerText = "Previsualización nombre de usuario: " + nombreusuarioSinTildes;
